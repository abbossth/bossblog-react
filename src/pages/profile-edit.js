...
const ProfileEdit = () => {
  return (
   ...
   <section class="es-regular-section es-profile-header-section">
     ...
     <div class="container">
       <div class="es-btn-update-banner">
         <button class="btn es-btn-light">
       ...
       <div class="es-profile-header-content mt-5">
       ...
       <div class="row">
         <div class="col-md-6">
           <div class="form-group es-form-group">
             ...
             <input type="text" class="form-control" id="name" placeholder="Akbarali" />
           </div>
         </div>
         <div class="col-md-6">
           <div class="form-group es-form-group">
             <label for="surname">Familiya</label>
             <input type="text" class="form-control" id="surname" placeholder="Khasanov" />
           </div>
         </div>
         <div class="col-12">
           <div class="form-group es-form-group">
             <label for="username">Foydalanuvchi nomi</label>
             <input type="text" class="form-control" id="username" placeholder="akbaralikhasanov" />
           </div>
         </div>
         <div class="col-12">
           <div class="form-group es-form-group">
             <label for="email">Email address</label>
             <input type="email" class="form-control" id="email" placeholder="akbaralikhasanov2000@gmail.com" />
           </div>
         </div>
         <div class="col-12">
           <div class="form-group es-form-group">
             <label for="bio">Bio</label>
             <textarea class="form-control" id="bio" rows="4" placeholder="I am student...."></textarea>
           </div>
         </div>
       </div>
       <button class="btn es-profile-save">
         <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
